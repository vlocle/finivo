                                ...
                                child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        const Text('Tổng chi phí biến đổi', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                        Text(currencyFormat.format(appState.variableExpense), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1976D2))),
                                      ],
                                    ),
                                  ),
                                ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    DropdownButton<String>(
                                      ...
                                      hint: const Text("Chọn khoản chi phí"),
                                      isExpanded: true,
                                      onChanged: (String? newValue) => setState(() => selectedExpense = newValue),
                                      items: availableExpenses.isEmpty
                                          ? [const DropdownMenuItem<String>(value: null, child: Text("Chưa có khoản chi phí nào"))]
                                          : availableExpenses.map((expense) => DropdownMenuItem<String>(value: expense['name'], child: Text(expense['name']))).toList(),
                                    ),
                                    const SizedBox(height: 16),
                                    TextField(
                                    ...
                                    ScaleTransition(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        child: const Text("Thêm chi phí", style: TextStyle(color: Colors.white, fontSize: 16)),
                                      ),
                                    ),
                                  ],
                                ),
                                      ...
                                      builder: (context, List<Map<String, dynamic>> expenses, _) {
                                        return Card(
                                          ...
                                          child: expenses.isEmpty
                                              ? const Center(child: Text("Chưa có chi phí biến đổi", style: TextStyle(fontSize: 16, color: Colors.grey)))
                                              : ListView.builder(
                                              ...
                                              return Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        const Icon(Icons.attach_money, size: 24, color: Color(0xFF1976D2)),
                                                        const SizedBox(width: 12),
                                                        Text(expenses[index]['name'], style: const TextStyle(fontSize: 16)),
                                                      ],
                                                    ),
                                                    Row(
                                                      children: [
  ...
  void editExpense(int index, AppState appState) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        title: Text("Chỉnh sửa số tiền - ${appState.variableExpenseList.value[index]['name']}"),
        content: TextField(
          controller: amountController,
          keyboardType: TextInputType.number,
          decoration: InputDecoration(
